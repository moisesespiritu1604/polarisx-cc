...
export default function CorredorVialInteroceanicoDelSurTramo2Cusco() {
  ...
  const imagenes = [
    {
      src: "/proyectos/proyecto-corredor-vial-interocanico-del-sur-tramo-2-cusco.png",
      alt: "Proyecto Corredor Vial Interoceánico del Sur Tramo 2 — portada",
    },
    {
      src: "/proyectos/proyecto-corredor-vial-interocanico-del-sur-tramo-2-cusco-2.png",
      alt: "Proyecto Corredor Vial Interoceánico del Sur Tramo 2 — página 1",
    },
  ];
  ...
  return (
    <>
      ...
      <Breadcrumb
        ...
        currentPage="Corredor Vial Interoceánico del Sur Tramo 2 - Cusco"
      />
      <HeroBanner
        sectionId="hero-section-corredor-vial-interoceanico-del-sur-tramo-2-cusco"
        backgroundImage="/proyectos/proyecto-corredor-vial-interocanico-del-sur-tramo-2-cusco.webp"
        title="Corredor Vial Interoceánico del Sur Tramo 2 - Cusco"
